...
import ProfilesPopup from '../ProfilesPopup/ProfilesPopup';
import { setProfile } from '../../Actions/profiles';
import { IStore } from '../../Reducers';
import * as style from './Profiles.module.scss'
...
const Profiles = () => {
  ...
  return (
    <div className={style.profiles}>
      <div className={style.profiles__inner}>
        <div className={style.profiles__items}>
          {
            data.map((p) => (
              <button
                ...
                className={cs(style.profiles__item, {
                  [style.profiles__item_active]: currentProfile === p.id,
                })}
              >
                {p.title}
              </button>
        ...
        {
          isLoaded && (
            <EditButton className={style.profiles__button} onClick={() => setPopup(true)} />
          )
        }
      </div>
